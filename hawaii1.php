...
if ($price == 0 or empty($price))
    $result = mysqli_query($conn,"SELECT * FROM catalog where City ='Maui, Hawaii'");
else    
    $result = mysqli_query($conn,"SELECT * FROM catalog where City ='Maui, Hawaii' and Price <= $price");
