...
if ($price == 0 or empty($price))
    $result = mysqli_query($conn,"SELECT * FROM catalog where City ='Tokyo'");
else    
    $result = mysqli_query($conn,"SELECT * FROM catalog where City ='Tokyo' and Price <= $price");
